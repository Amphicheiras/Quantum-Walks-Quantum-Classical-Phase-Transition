function [position, deviation] = QW_ambainis(Number_Of_Steps, Number_Of_Dimensions, V_q, coin_walker_density1)

position = zeros(1,2*Number_Of_Dimensions+1);
deviation = zeros(1,Number_Of_Dimensions);

for index=1:Number_Of_Steps
	coin_walker_density = V_q^index*coin_walker_density1*V_q^index';
